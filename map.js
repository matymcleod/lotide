...
// Test code:
assertArraysEqual(words, map(words, word => word)); // => pass
assertArraysEqual(words, map(words, word => word[0])); // => fail
console.log(map(words, x => x)); // logging the result of the map function